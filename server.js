...
const postModal =mongoose.model("po",postSchema);



mongoose.connect("mongodb+srv://sahil:sahil98@cluster0.xqdlh.mongodb.net/instaclone?retryWrites=true&w=majority",{ useNewUrlParser: true, useUnifiedTopology: true },
  () => {
